...
const ChatIA = ({ showChatModal, setShowChatModal }) => {
  ...
  const obtenerRespuestaIA = async (promptUsuario) => {
    ...
    const prompt = `Extrae el nombre y la descripción de categoría en este mensaje: "${promptUsuario}". Si el usuario no provee una descripción, generas una descripción corta basándote en el nombre. Asegúrate que el nombre y descripción comiencen con mayúsculas. Devuélvelo en JSON como {"nombre": "...", "descripcion": "..."}.`;
